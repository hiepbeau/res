...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendors/bootstrap-slider/css/bootstrap-slider.min.css')); ?>" />
                            ...
                            <div class="row">
                                <div class="col-md-4 col-md-offset-4">
                                    ...
                                    <div> <b class="margin_right15">1</b>
                                        <input id="id_range" type="text" data-slider-id='id_range' class="slider form-control" data-slider-handle="square" value="" data-slider-min="1" data-slider-max="<?php echo e($max_count); ?>" data-slider-step="1" data-slider-value="[1,3]"/> <b style="margin-left: 15px;"><?php if(!empty($max_count)): ?><?php echo e($max_count); ?> <?php else: ?> 10 <?php endif; ?></b>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                ...
                                <?php echo Form::select('professions', $professions, null,['class' => 'form-control', 'id' => 'professions']); ?>
                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div> <b class="margin_right15">1</b>
                                        <input id="id_range2" type="text" data-slider-id='id_range' class="slider form-control" data-slider-handle="square" value="" data-slider-min="1" data-slider-max="<?php echo e($max_count); ?>" data-slider-step="1" data-slider-value="[1,3]"/> <b style="margin-left: 15px;"><?php if(!empty($max_count)): ?><?php echo e($max_count); ?> <?php else: ?> 10 <?php endif; ?></b>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="col-md-3">
                                        <label class="control-label">Profession :</label>
                                        <?php echo Form::select('professions', $professions, null,['class' => 'form-control', 'id' => 'professions2']); ?>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('assets/vendors/jeditable/js/jquery.jeditable.js')); ?>" ></script>
    ...
    <script src="<?php echo e(asset('assets/vendors/bootstrap-slider/js/bootstrap-slider.js')); ?>" ></script>
    ...
    <script>
        ...
        $(function() {
            ...
            var table = $('#table1').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo URL::to('admin/custom_datatables/sliderData'); ?>',
                    data: function (d) {
                        d.idSlider = idSlider;
                    }
                },
            ...
            var table2 = $('#table2').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo URL::to('admin/custom_datatables/radioData'); ?>',
                    data: function (d) {
                        d.ageRadio=ageRadio;
                    }
                },
            ...
            var table3 = $('#table3').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo URL::to('admin/custom_datatables/selectData'); ?>',
                    data: function (d) {
            ...
            var table4 = $('#table4').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo URL::to('admin/custom_datatables/buttonData'); ?>',
                    data: function (d) {
            ...
            var table5 = $('#table5').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo URL::to('admin/custom_datatables/totalData'); ?>',
                    data: function (d) {

...
public class WidgetService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        RemoteViews updateViews = new RemoteViews("hiepnguyen.nhcver2",
                R.layout.widget);
        RestaurantHelper helper = new RestaurantHelper(this);
        AppWidgetManager mgr = AppWidgetManager.getInstance(this);
        //Find how many restaurant there are via a sql
        try {
            Cursor c = helper
                    .getReadableDatabase()
            ...
            if (count > 0) {
                ...
                Intent i = new Intent(this, DetailFormActivity.class);

                i.putExtra(AddRestaurantActivity.ID_EXTRA, c.getString(0));

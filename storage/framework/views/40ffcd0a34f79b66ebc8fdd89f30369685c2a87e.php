                ...
                <div id="container_demo">
                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="<?php echo e(route('signin')); ?>" autocomplete="on" method="post" role="form" id="login_form">
                                ...
                                <div class="form-group <?php echo e($errors->first('password', 'has-error')); ?>">
                                    ...
                                    <input id="password" name="password" type="password" placeholder="Enter a password" va />
                                    <div class="col-sm-12">
                        ...
                        <div id="register" class="animate form">
                            <form action="<?php echo e(route('signup')); ?>" autocomplete="on" method="post" role="form" id="register_here">
                                <h3 class="black_bg">
                                    <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="josh logo">
                                    <br>Sign Up</h3>
                                    <!-- CSRF Token -->
                                    ...
                                    <div class="form-group <?php echo e($errors->first('email', 'has-error')); ?>">
                                        ...
                                        <input id="email" name="email" value="<?php echo old('email'); ?>" required type="email"
                        ...
                        <div id="forgot" class="animate form">
                            <form action="<?php echo e(url('admin/forgot-password')); ?>" autocomplete="on" method="post" role="form" id="reset_pw">
                                <h3 class="black_bg">
                                    <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="josh logo"><br>Forgot Password</h3>
                                <p>

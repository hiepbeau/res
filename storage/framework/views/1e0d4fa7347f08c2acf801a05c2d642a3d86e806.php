...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link href="<?php echo e(asset('assets/css/pages/sortable_list.css')); ?>" rel="stylesheet">
                    ...
                    <div id="multi">
                        <div class="layer tile" data-force="30">
                            ...
                            <div class="tile__list">
                                <img src="<?php echo e(asset('assets/img/authors/avatar.jpg')); ?>"/>
                                <img src="<?php echo e(asset('assets/img/authors/avatar1.jpg')); ?>"/>
                                <img src="<?php echo e(asset('assets/img/authors/avatar2.jpg')); ?>"/>
                                <img src="<?php echo e(asset('assets/img/authors/avatar3.jpg')); ?>"/>
                            </div>
                        </div>
                        <div class="layer tile" data-force="25">
                            <div class="tile__name">Group B</div>
                            <div class="tile__list">
                                <img src="<?php echo e(asset('assets/img/authors/avatar4.jpg')); ?>"/>
                                <img src="<?php echo e(asset('assets/img/authors/avatar5.jpg')); ?>"/>
                                <img src="<?php echo e(asset('assets/img/authors/avatar6.jpg')); ?>"/>
                            </div>
                        </div>
                        <div class="layer tile" data-force="20">
                            <div class="tile__name">Group C</div>
                            <div class="tile__list">
                                <img src="<?php echo e(asset('assets/img/authors/avatar7.jpg')); ?>"/>
                                <img src="<?php echo e(asset('assets/img/authors/avatar.jpg')); ?>"/>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script src="<?php echo e(asset('assets/vendors/Sortable/js/Sortable.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('assets/js/pages/sortable_list.js')); ?>" type="text/javascript"></script>

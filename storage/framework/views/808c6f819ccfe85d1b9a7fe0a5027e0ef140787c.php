        ...
        <nav class="navbar navbar-default container">
            ...
            <div class="collapse navbar-collapse" id="collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown <?php echo (Request::is('typography') || Request::is('advancedfeatures') || Request::is('grid') ? 'active' : ''); ?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> Features</a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo e(URL::to('typography')); ?>">Typography</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('advancedfeatures')); ?>">Advanced Features</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('grid')); ?>">Grid System</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown <?php echo (Request::is('aboutus') || Request::is('timeline') || Request::is('faq') || Request::is('blank_page')  ? 'active' : ''); ?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> Pages</a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo e(URL::to('aboutus')); ?>">About Us</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('timeline')); ?>">Timeline</a></li>
                            <li><a href="<?php echo e(URL::to('price')); ?>">Price</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('404')); ?>">404 Error</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('500')); ?>">500 Error</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('faq')); ?>">FAQ</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('blank_page')); ?>">Blank</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown <?php echo (Request::is('products') || Request::is('single_product') || Request::is('compareproducts') || Request::is('category')  ? 'active' : ''); ?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> Shop</a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo e(URL::to('products')); ?>">Products</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('single_product')); ?>">Single Product</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('compareproducts')); ?>">Compare Products</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('category')); ?>">Categories</a></li>
                        </ul>
                    </li>
                    <li class="dropdown <?php echo (Request::is('portfolio') || Request::is('portfolioitem') ? 'active' : ''); ?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> Portfolio</a>
                        <ul class="dropdown-menu" role="menu">
                    ...
                    <li class="dropdown <?php echo (Request::is('news') || Request::is('news_item') ? 'active' : ''); ?>"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> News</a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="<?php echo e(URL::to('news')); ?>">News</a>
                            </li>
                            <li><a href="<?php echo e(URL::to('news_item')); ?>">News Item</a>
                            </li>
                        </ul>
                    </li>

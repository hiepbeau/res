...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#"> <?php echo app('translator')->get('groups/title.groups'); ?></a></li>
        <li class="active"><?php echo app('translator')->get('groups/title.groups_list'); ?></li>
    </ol>
</section>
            ...
            <div class="panel panel-primary ">
                <div class="panel-heading clearfix">
                    <h4 class="panel-title pull-left"> <i class="livicon" data-name="users" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                        <?php echo app('translator')->get('groups'); ?>
                    </h4>
                    <div class="pull-right">
                    <a href="<?php echo e(route('admin.groups.create')); ?>" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> <?php echo app('translator')->get('button.create'); ?></a>
                    </div>
                </div>
                <br />
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.groups.edit', $role->id)); ?>">
                                            ...
                                            <?php if($role->id !== 1): ?>
                                                ...
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('admin.groups.confirm-delete', $role->id)); ?>" data-toggle="modal" data-target="#delete_confirm">

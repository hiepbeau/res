...
<?php $__env->startSection('header_styles'); ?>
    <link href="<?php echo e(asset('assets/css/pages/invoice.css')); ?>" rel="stylesheet" type="text/css"/>
<?php $__env->stopSection(); ?>
                        ...
                        <div class="panel panel-success">
                            ...
                            <div class="panel-body" style="border:1px solid #ccc;padding:0;margin:0;">
                                <div class="row" style="padding: 15px;margin-top:5px;">
                                    <div class="col-md-6">
                                        <img src="<?php echo e(asset('assets/img/logo2.png')); ?>" alt="logo" class="img-responsive">
                                    </div>
                                    <div class="col-md-6">
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script  src="<?php echo e(asset('assets/js/pages/invoice.js')); ?>"  type="text/javascript"></script>

    ...
    <div class="row">
        <div class="box animation flipInX">
            ...
            <form action="<?php echo e(route('register')); ?>" method="POST" id="reg_form">
                ...
                Already have an account? Please <a href="<?php echo e(route('login')); ?>"> Log In</a>
            </form>
        </div>
    </div>
    <!-- //Content Section End -->
...
<script type="text/javascript" src="<?php echo e(asset('assets/js/frontend/register_custom.js')); ?>"></script>
<!--global js end-->
</body>
</html>

...
<?php $__env->startSection('header_styles'); ?>
    ...
    <link href="<?php echo e(asset('assets/vendors/dropzone/css/dropzone.css')); ?>" rel="stylesheet" type="text/css" />
                ...
                <div class="panel panel-info" style="overflow:auto;">
                    ...
                    <div class="panel-body" style="padding:0px !important;">
                        <div class="col-md-12" style="padding:30px;">
                            <?php echo Form::open(array('url' => URL::to('admin/file/create'), 'method' => 'post', 'id'=>'myDropzone','class' => 'dropzone', 'files'=> true)); ?>
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('assets/vendors/dropzone/js/dropzone.js')); ?>" ></script>
    <script>

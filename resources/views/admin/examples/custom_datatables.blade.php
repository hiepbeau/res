                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                ...
                                {!! Form::select('professions', $professions, null,['class' => 'form-control', 'id' => 'professions']) !!}
                            </div>
                            </div>
                            <div class="panel-body table-responsive">
                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div> <b class="margin_right15">1</b>
                                        <input id="id_range2" type="text" data-slider-id='id_range' class="slider form-control" data-slider-handle="square" value="" data-slider-min="1" data-slider-max="{{$max_count}}" data-slider-step="1" data-slider-value="[1,3]"/> <b style="margin-left: 15px;">@if(!empty($max_count)){{$max_count}} @else 10 @endif</b>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="col-md-3">
                                        <label class="control-label">Profession :</label>
                                        {!! Form::select('professions', $professions, null,['class' => 'form-control', 'id' => 'professions2']) !!}
                                    </div>
                            </div>
                            <div class="panel-body table-responsive">

                        ...
                        <div class="form-group <?php echo e($errors->
                            ...
                            <div class="col-sm-5">
                                <select class="form-control" name="loainhahang">
                                    <?php $__currentLoopData = $lnh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        <option value="<?php echo e($i->idlnh); ?>"><?php echo e($i->tenlnh); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                </select>
                            </div>
                            <div class="col-sm-4">

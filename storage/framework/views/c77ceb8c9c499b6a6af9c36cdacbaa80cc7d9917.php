            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 wow zoomIn" data-wow-duration="3s">
                    <div class="layout-image">
                        <img src="<?php echo e(asset('assets/images/layout.png')); ?>" alt="layout" class="img-responsive" />
                    </div>
                </div>
    ...
    <div class="container">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_default_1">
                                <div class="media">
                                    <div class="media-left tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="<?php echo e(asset('assets/images/authors/img1.jpg')); ?>" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
                            ...
                            <div class="tab-pane" id="tab_default_2">
                                <div class="media">
                                    <div class="media-left media-middle tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="<?php echo e(asset('assets/images/authors/img2.jpg')); ?>" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
                            ...
                            <div class="tab-pane" id="tab_default_3">
                                <div class="media">
                                    <div class="media-left media-middle tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="<?php echo e(asset('assets/images/authors/img3.jpg')); ?>" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
                            ...
                            <div class="tab-pane" id="tab_default_4">
                                <div class="media">
                                    <div class="media-left media-middle tab col-sm-12">
                                        <a href="#">
                                            <img class="media-object img-responsive" src="<?php echo e(asset('assets/images/authors/img4.jpg')); ?>" alt="image">
                                        </a>
                                    </div>
                                </div>
                                <p>
        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInLeft" data-wow-duration="3s">
                <div class="thumbnail bg-white">
                    <img src="<?php echo e(asset('assets/images/img_3.jpg')); ?>" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <b>John Doe</b>
                        <br /> Founder & Partner
                        <br />
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInUp" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail bg-white">
                    <img src="<?php echo e(asset('assets/images/img_5.jpg')); ?>" alt="team-image">
                    <div class="caption">
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInDown" data-wow-duration="3s" data-wow-delay="1s">
                <div class="thumbnail bg-white">
                    <img src="<?php echo e(asset('assets/images/img_4.jpg')); ?>" alt="team-image" class="img-responsive">
                    <div class="caption">
                        <b>Audrey Sheldon</b>
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInRight" data-wow-duration="3s" data-wow-delay="1.5s">
                <div class="thumbnail bg-white">
                    <img src="<?php echo e(asset('assets/images/img_6.jpg')); ?>" alt="team-image">
                    <div class="caption">
                        <b>Sam Bellows</b>
                        <br /> Manager
                        <br />
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 wow zoomInLeft" data-wow-duration="3s">
                ...
                <img src="<?php echo e(asset('assets/images/image_12.jpg')); ?>" alt="image_12" class="img-responsive">
                <p>
            ...
            <div class="col-md-6 col-sm-6 wow zoomInRight" data-wow-duration="3s">
                ...
                <img src="<?php echo e(asset('assets/images/image_11.jpg')); ?>" alt="image_11" class="img-responsive">
                <p>
                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
                </p>
                <p>
        ...
        <div class="row">
            ...
            <div class="col-md-4 wow bounceInLeft" data-wow-duration="3s">
                <div class="author">
                    <img src="<?php echo e(asset('assets/images/authors/avatar3.jpg')); ?>" alt="avatar3" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
            ...
            <div class="col-md-4 wow bounceIn" data-wow-duration="3s">
                <div class="author">
                    <img src="<?php echo e(asset('assets/images/authors/avatar2.jpg')); ?>" alt="avatar2" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
                        <small class="text-right">Themeforest.net</small>
            ...
            <div class="col-md-4 wow bounceInRight" data-wow-duration="3s">
                <div class="author">
                    <img src="<?php echo e(asset('assets/images/authors/avatar4.jpg')); ?>" alt="avatar4" class="img-responsive img-circle pull-left">
                    <p class="text-right">
                        Tonny Jakson
                        <br>
                        <small class="text-right">Themeforest.net</small>

...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/vendors/fort_js/css/fort.css')); ?>" />
    ...
    <div class="login-container">
        ...
        <div>
            <?php if(Sentinel::getUser()->pic): ?>
                <img class="img-responsive img-circle" src="<?php echo url('/').'/uploads/users/'.Sentinel::getUser()->pic; ?>" alt="profile pic">
            <?php else: ?>
                <img src="http://api.adorable.io/avatars/54/<?php echo Sentinel::getUser()->email; ?>"
...
<script src="<?php echo e(asset('assets/vendors/fort_js/js/fort.js')); ?>"></script>
